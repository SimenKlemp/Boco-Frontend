  ...
  <div class="mainContent">
    <form class="form" @submit.prevent="submit" id="form">
      ...
      <div class="optionsContainer">
        ...
        <svg v-if="gridView"  xmlns="http://www.w3.org/2000/svg" width="39.2" height="28" viewBox="0 0 39.2 28" @click="changeView">
        <g id="noun-list-4781885" transform="translate(-147 -153)">
          ...
          <svg v-if="!gridView" xmlns="http://www.w3.org/2000/svg" width="28" height="28.008" viewBox="0 0 28 28.008" @click="changeView" >
          ...
          <svg @click="changeFilterView" xmlns="http://www.w3.org/2000/svg" width="31.886" height="28" viewBox="0 0 31.886 28">
